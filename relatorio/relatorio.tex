...
\draw[arr](B6)--node[above,font=\scriptsize]{não}(B8);
...
\draw[arr](B9)--node[right,font=\scriptsize]{falha}(Br);
\draw[arr](Br)-|(B8);
...
Este trabalho utilizou Claude Code (Anthropic) como ferramenta de apoio. O grupo
revisou o que foi gerado em cada etapa antes de incorporar ao trabalho.
...
O grupo entende a arquitetura, a ingestão, a recuperação, a validação e os
experimentos, e está preparado para defender as decisões técnicas na apresentação.
